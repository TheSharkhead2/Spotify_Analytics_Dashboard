...
const SCOPE: &str = "user-read-private user-read-recently-played";
...
fn main() {
    ...
    tauri::Builder::default()
        .manage(state)
        .invoke_handler(tauri::generate_handler![authorization_codeflow, authenticated, get_recent_song_data_feature])
